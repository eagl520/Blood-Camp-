                ...
                child: SafeArea(
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildOrganizerHeader(context, currentUser),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildMenuItem(
                                ...
                                title: 'Create Camps',
                                subtitle: 'Launch a new blood camp',
                                iconColor: kPrimary,
                                onTap: () {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => const NewCampScreen(),
                                    ),
                                  );
                                },
                              ),
                              _buildMenuItem(
                                ...
                                subtitle: 'View camp & donor analytics',
                                iconColor: kPrimary,
                                onTap: () {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => const OrganizerReportScreen(),
                                    ),
                                  );
                                },
                              ),
...
Widget _buildOrganizerHeader(BuildContext context, User? currentUser) {
  return Container(
